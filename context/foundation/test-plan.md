...
|---|---|---|---|
| unit + integration | Vitest (recommended) | none yet — see §3 Phase 1 | Vite-native, matches the Astro/Vite toolchain; pin at plan time |
...
- TBD — see §3 Phase 1 (suggestion-normalizer contract pattern: never-throws + contract-valid output across provider shape variants, oracle drawn from the PRD care-profile fields).
